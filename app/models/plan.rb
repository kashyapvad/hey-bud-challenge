  ...
  def update_report report
    ...
    r[:parameters] += rep[:report].map do |h| 
      h.transform_keys do |k| 
        ...
        key = "extracted/analyzed_value" if key.eql? "extracted/analyzed_values" or key.eql? "extracted_value/analyzed_value" or key.eql? "extracted_values/analyzed_values" or key.eql? "extracted_values/analyzed_value" or key.eal? "extracted_value/analyzed_values"
        key
      end
    end
